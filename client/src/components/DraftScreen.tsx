    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 p-8">
      <div className="max-w-7xl mx-auto">
        <header className="text-center mb-8">
          <h1 className="text-4xl font-bold text-blue-400 mb-2">Team Drafting</h1>
          <p className="text-slate-300">Build your dream team for the ultimate HR battle!</p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-slate-800 rounded-lg border border-slate-700 p-6">
              <h2 className="text-2xl font-semibold mb-4 text-green-400">Available Units</h2>
                  ...
                  return (
                    ...
                    >
                      <div className="text-center">
                        ...
                        <p className="text-green-400 font-mono text-sm mb-2">${cost}k</p>
          ...
          <div className="space-y-6">
            {/* Budget & Headcount */}
            <div className="bg-slate-800 rounded-lg border border-slate-700 p-6">
              <h2 className="text-xl font-semibold mb-4 text-blue-400">Team Status</h2>
            ...
            {/* Selected Units */}
            <div className="bg-slate-800 rounded-lg border border-slate-700 p-6">
              <h2 className="text-xl font-semibold mb-4 text-purple-400">Your Team</h2>
            ...
            {/* AI Team Preview */}
            <div className="bg-slate-800 rounded-lg border border-slate-700 p-6">
              <h2 className="text-xl font-semibold mb-4 text-red-400">AI Team</h2>
